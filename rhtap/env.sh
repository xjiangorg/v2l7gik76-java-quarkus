...
export GITOPS_REPO_URL=https://github.com/xjiangorg/v2l7gik76-java-quarkus-gitops
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-rhtap-tas.apps.rosa.xjiang0303417.0lal.p3.openshiftapps.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-rhtap-tas.apps.rosa.xjiang0303417.0lal.p3.openshiftapps.com}
